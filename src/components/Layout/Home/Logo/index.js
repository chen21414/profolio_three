...
import Cave_man_original from "../../../../assets/images/Cave_man_original";
...
const Logo = () => {
  ...
  //   });
  //   return <Cave_man_original ref={boxRef} />;
  // };

  return (
    <div className="canvas solid-logo">
      <Canvas>
